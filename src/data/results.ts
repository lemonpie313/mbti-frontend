...
const results: ResultData[] = [
  ...
  },
  {
    ...
    artistName: "ILLIT",
    recommendation: "섬세하고 감성적인 가사와 부드러운 무드가 어우러져서, 마음속 감정에 오래 머무는 성향과 잘 어울려요.",
  },
  {
    mbti: "INFJ",
    title: "고요하지만 깊은 팬심",
    ...
    trackId: "2f79jWcTf2pxVxDLdxi1Lm",
    artistId: "6RHTUrRF63xao58xh9FXYJ",
    artistName: "IVE",
    recommendation: "세련된 멜로디와 감정선이 깊은 가사가 많아서, 감정의 여운을 소중히 여기는 성향과 잘 맞아요.",
  },
  {
    mbti: "INTP",
    title: "뮤직비디오 분석러",
    ...
    trackId: "1Ql33tND0vujOBXqvVtzau",
    artistId: "63sat2XSMKdwKfqspmYQKP",
    artistName: "KiiiKiii",
    recommendation: "실험적인 사운드와 감각적인 연출이 돋보여서, 음악 속 구조와 흐름에 집중하는 성향과 잘 어울려요.",
  },
  {
    mbti: "INTJ",
    title: "셋리스트 설계의 달인",
  ...
  },
  {
    ...
    trackId: "53DDMPqgMWNrEeE3NjThKE",
    artistId: "4GJ6xDCF5jaUqD6avOuQT6",
    artistName: "FiftyFifty",
    recommendation: "부드럽고 감성적인 사운드가 매력적이라, 조용히 몰입하며 감정선을 따라가는 타입과 잘 어울려요.",
  },
  {
    mbti: "ISFJ",
    title: "아티스트를 돌보는 마음",
